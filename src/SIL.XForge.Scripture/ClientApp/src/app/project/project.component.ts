      ...
      async projectId => {
        ...
        if (project == null || projectUserConfig == null) {
          const message: string =
            `There was a problem finding a project (${projectDoc.id}) or user specific ` +
            `information for the project (${projectUserConfigDoc.id}). Maybe there was a typo in the URL you ` +
            `specified. Maybe you tried to access a project that is no longer available.`;

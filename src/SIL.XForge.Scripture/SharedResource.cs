namespace SIL.XForge.Scripture
{
    ...
    public class SharedResource
    {
        public static class Keys
        {
            ...
            public static string ErrorNoSuchProject = "ErrorNoSuchProject";
            public static string ErrorNoSuchPTProj = "ErrorNoSuchPTProj";
            public static string ErrorNoSuchUser = "ErrorNoSuchUser";
            public static string ErrorNoSourcePTProj = "ErrorNoSourcePTProj";
        }
    }
}

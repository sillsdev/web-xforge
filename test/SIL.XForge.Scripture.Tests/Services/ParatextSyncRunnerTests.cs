...
And it came to <char style=""w"">pass</char> <char style=""w"">in</char> the days</para>
    ...
    [Test]
    public async Task GetBookUsx_ExpectedFormatting()
    {
        TestEnvironment env = new();
...
And it came to <char style=""w"">pass</char> <char style=""w"">in</char> the days </para>
        ...
        string expectedUsx =
            @"<usx version=""3.0"">
<book code=""RUT"" style=""id"">- American Standard Version</book><chapter number=""1"" style=""c"" /><para style=""p""><verse number=""1"" style=""v"" />And it came to <char style=""w"">pass</char> <char style=""w"">in</char> the days </para></usx>";
        string actualUsx = TestEnvironment.XDocumentToStringUnformatted(result);
        Assert.That(actualUsx, Is.EqualTo(expectedUsx));
    }

    [Test]
    public async Task GetBookUsx_ExpectedFormatting2()
    {
        TestEnvironment env = new();
    ...
    private class TestEnvironment
    {
        ...
        /// <summary>
        /// XDocument.ToString() formats the output, such as with indentation. This method returns a string
        /// representation of an XDocument without formatting, which can be useful when paying attention to what
        /// whitespace is really in the XDocument.
        /// </summary>

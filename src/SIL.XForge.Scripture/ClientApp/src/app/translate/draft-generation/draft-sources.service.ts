...
export class DraftSourcesService {
  ...
  private async mapDraftSourceToFullSource(
    ...
    const currentUser = await this.userService.getCurrentUser(FETCH_WITHOUT_SUBSCRIBE);
    ...
    if (source === currentProjectDoc?.data) project = currentProjectDoc.data;
      ...
      project = (await this.projectService.getProfile(projectId, FETCH_WITHOUT_SUBSCRIBE)).data;
    }

...
import { CsvParser } from 'xforge-common/csv-parser.service';
...
const mockedCsvParser = mock(CsvParser);
...
describe('ImportQuestionsDialogComponent', () => {
  configureTestingModule(() => ({
    ...
    providers: [
      ...
      { provide: CsvParser, useMock: mockedCsvParser }
    ]
  }));
  ...
  it('can import from a CSV file', fakeAsync(() => {
    ...
    when(mockedCsvParser.parse(anything())).thenResolve(genQuestions.concat(matQuestions));

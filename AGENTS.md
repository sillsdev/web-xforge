...
- Use good argument and variable names that explain themselves without needing a comment. Well named arguments or variables with no comment are better than unclearly named arguments or variables with an explanatory comment.

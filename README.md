...
In the guest development machine, after compiling and running Scripture Forge, browse to http://localhost:5000 and use the default login credentials "admin" and "password".

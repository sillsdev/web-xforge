...
/**
 * Localized, conjunction-joined training-book list for the summary table (e.g. "Genesis, Exodus (1-10), and
 * Leviticus"). Full books collapse into ranges; partial books show their chapters.
 */

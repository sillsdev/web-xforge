...
@Component({
  ...
  standalone: true,
  templateUrl: './draft-onboarding-requests.component.html',
  styleUrls: ['./draft-onboarding-requests.component.scss'],
  imports: [
    CommonModule,
    FormsModule,
    TranslocoModule,
...
export class OnboardingFormComponent extends DataLoadingComponent implements OnInit {

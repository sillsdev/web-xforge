...
namespace Paratext.Base
{
    ...
    public class MockScrText : ScrText
    {
        ...
        public override ScrStylesheet DefaultStylesheet => new MockScrStylesheet(
            "/home/vagrant/src/web-xforge/src/SIL.XForge.Scripture/bin/Debug/netcoreapp2.1/usfm.sty");

...
public class ParatextSyncRunner : IParatextSyncRunner
{
    ...
    )
    {
        ...
        {
            message =
                $"The user {_paratextService.GetParatextUsername(_userSecret)} could not sync the Biblical Terms for the following reason: {message}";
    ...
    )
    {
        ...
        {
            message =
                $"The user {_paratextService.GetParatextUsername(_userSecret)} could not retrieve the Biblical Terms for the following reason: {message}";

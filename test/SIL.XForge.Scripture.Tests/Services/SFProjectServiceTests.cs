    ...
    public class SFProjectServiceTests
    {
        ...
        public async Task UpdateSettingsAsync_EnableTranslate_CreateMachineProjectAndSync()
        {
            ...
            await env.Service.UpdateSettingsAsync(
                User01,
                Project01,
                new SFProjectSettings { TranslationSuggestionsEnabled = true, SourceParatextId = "changedId" }
            );
                        ...
                        new[]
                        {
                            ...
                            new SFProject
                            {
                                ...
                                TranslateConfig =
                                {
                                    ...
                                    Source = new TranslateSource { ProjectRef = DisabledSource, ParatextId = "pt_dis" }
                                },
                                UserRoles =
                                {
                                    { User01, SFProjectRole.Administrator },

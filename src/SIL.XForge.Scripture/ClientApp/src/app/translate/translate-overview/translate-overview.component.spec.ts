...
class TestEnvironment {
  ...
  private addTextDoc(id: TextDocId, allSegmentsBlank?: boolean): void {
    ...
    if (allSegmentsBlank) {
      delta.insert('', { segment: `verse_${id.chapterNum}_1` });
    } else {

import { Locator, Page, PageScreenshotOptions } from 'npm:playwright';
...
export async function screenshot(
  ...
  await page.screenshot({ path: `${preset.outputDir}/${fileName}`, fullPage: true, ...screenshotOptions });
...
export async function installMouseFollower(page: Page, animationMs = 200): Promise<void> {
  const document: any = {};

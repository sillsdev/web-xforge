...
namespace SIL.XForge.Scripture.Services
{
    public class DeltaUsxMapper : IDeltaUsxMapper
    {
        ...
        {
            public string LastVerse = null;
            public string CurRef = null;
            public int CurChapter = 0;
            public int TableIndex = 0;
            public bool TopLevelVerses = false;
        }
        ...
        {
            var temporaryState = new ParseState();
            ProcessChildNodes(newDelta, parentElem, temporaryState);
        }

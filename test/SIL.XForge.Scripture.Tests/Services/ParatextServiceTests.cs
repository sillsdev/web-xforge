...
public class ParatextServiceTests
{
    ...
    public void PutNotes_AddEditDeleteComment_ThreadCorrectlyUpdated()
    {
        ...
        string updateNotesString = TestEnvironment.GetUpdateNotesString(threadId, env.User01, date, content, verseRef);
        ...
        updateNotesString = TestEnvironment.GetUpdateNotesString(threadId, env.User01, date, content, verseRef);
        ...
        // Delete a comment
        updateNotesString = TestEnvironment.GetUpdateNotesString(threadId, env.User01, date, content, verseRef, true);
        syncMetricInfo = env.Service.PutNotes(userSecret, ptProjectId, updateNotesString);
    ...
    ""resources"": [
        ...
        public void AddNoteThreadData(ThreadComponents[] threadComponents)
        {
            ...
            foreach (var comp in threadComponents)
            {
                ...
                string threadIcon = comp.notes == null ? "icon1" : $"icon{comp.notes[^1].tagsAdded[0]}";
        ...
        public static string GetUpdateNotesString(
            string threadId,
            string user,
            DateTime date,
            string content,
        ...
        public static void SetupCommentTags(MockScrText scrText)
        {
            ...
            CommentTags.CommentTagList list = new CommentTags.CommentTagList { SerializedData = tags };

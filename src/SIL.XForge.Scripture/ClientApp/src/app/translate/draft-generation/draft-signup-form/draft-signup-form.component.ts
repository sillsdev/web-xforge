 ...
 */
@Component({
  selector: 'app-draft-signup-form',
  templateUrl: './draft-signup-form.component.html',
  styleUrls: ['./draft-signup-form.component.scss'],
...
export class DraftSignupFormComponent extends DataLoadingComponent implements OnInit {
  ...
  async onSubmit(): Promise<void> {
    if (this.signupForm.valid) {
      ...
      try {
        const requestId = await this.draftingSignupService.submitSignupRequest(

...
import { toVerseRef, VerseRefData } from '../models/verse-ref-data';
...
describe('BiblicalTermService', () => {
  ...
  it('allows user to edit biblical term', async () => {
    ...
    await submitJson0Op<BiblicalTerm>(conn, BIBLICAL_TERM_COLLECTION, docId, op => op.set(b => b.description, content));

...
public class ParatextService : DisposableBase, IParatextService
{
    ...
    private DotNetCoreAlert _alertSystem;
    ...
    )
    {
        ...
        try
        {
            ...
            // irrelevant syncs or areas at the same time, along with the desired information. These internal messages,
            // including messages from unrelated projects, are not necessarily for displaying to a user in error
            // reports.

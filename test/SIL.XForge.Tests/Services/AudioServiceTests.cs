...
internal class AudioServiceTests
{
    ...
    {
        var env = new TestEnvironment();
        var stream = new MemoryStream(new byte[] { 0x44, 0x2E, 0x56, 0x2E });
    ...
    {
        var env = new TestEnvironment();
        var stream = new MemoryStream(new byte[] { 0x0, 0x0, 0x0, 0x0 });
    ...
    {
        var env = new TestEnvironment();
        var stream = new MemoryStream(new byte[] { 0x49, 0x44, 0x33, 0x03 });
    ...
    {
        var env = new TestEnvironment();
        var stream = new MemoryStream(new byte[] { 0xFF, 0xEB, 0x10, 0x0 });
    ...
    {
        var env = new TestEnvironment();
        var stream = new MemoryStream(new byte[] { 0xFF, 0xF3, 0x28, 0xC4 });
    ...
    {
        var env = new TestEnvironment();
        var stream = new MemoryStream(new byte[] { 0x0, 0x0, 0x0, 0xFF, 0xF3, 0x28, 0xC4 });
    ...
    {
        var env = new TestEnvironment();
        var stream = new MemoryStream(new byte[] { 0x49, 0x44, 0x33, 0x0 });

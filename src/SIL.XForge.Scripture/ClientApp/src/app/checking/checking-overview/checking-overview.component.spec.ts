...
describe('CheckingOverviewComponent', () => {
  ...
  describe('Archive Question', () => {
    ...
    it('archives and republishes a question', fakeAsync(() => {
      ...
      expect(env.getArchivedQuestionsCountByRow(0)).toContain('1 questions');
      env.simulateRowClick(0);
      env.simulateRowClick(1, id);
      expect(env.textRows.length).toEqual(9);
      ...
      expect(env.textArchivedRows.length).toEqual(1);
      expect(env.getArchivedQuestionsCountByRow(0)).toContain('2 questions');
    ...
    it('archives and republishes questions for an entire chapter or book', fakeAsync(() => {
      ...
      expect(env.getPublishedQuestionsCountByRow(1)).toContain('6 questions');
      ...
      expect(env.getArchivedQuestionsCountByRow(0)).toContain('7 questions');
      ...
      expect(env.getArchivedQuestionsCountByRow(1)).toContain('7 questions');
      ...
      expect(env.getPublishedQuestionsCountByRow(0)).toContain('7 questions');
      ...
      expect(env.getArchivedQuestionsCountByRow(0)).toContain('7 questions');
      expect(env.getArchivedQuestionsCountByRow(1)).toContain('1 questions');
      ...
      expect(env.textRows.length).toEqual(2);
      expect(env.getPublishedQuestionsCountByRow(0)).toContain('7 questions');
      expect(env.getPublishedQuestionsCountByRow(1)).toContain('1 questions');
    }));
  });
...
class TestEnvironment {
  ...
  getPublishedQuestionsCountByRow(row: number): string {
    return this.questions.queryAll(By.css('mdc-list-item .questions-count'))[row].nativeElement.textContent;
  }

  getArchivedQuestionsCountByRow(row: number): string {

...
public class ParatextServiceTests
{
    ...
    // TODO: only delete the thread if note thread marked deleted
    // if comment marked deleted in sf but does not exist in pt, do nothing
    [Test]

...
export class ShareControlComponent extends SubscriptionDisposable {
  ...
  async updateFormEnabledStateAndLinkSharingKey() {
  ...
  get roles(): ProjectRoleInfo[] {
    ...
    return SF_PROJECT_ROLES.filter(info => info.canBeShared && availableRoles.includes(info.role));
  }
  ...
  get isLinkSharingEnabled(): boolean {
    ...
    return shareSettings[this.shareRole] === true;
  }

...
export interface CheckingResponse {
  ...
  scripture?: string;
  scriptureStartClipped?: boolean;
  scriptureEndClipped?: boolean;
}
...
export class CheckingCommentFormComponent extends SubscriptionDisposable implements AfterViewInit {
  ...
  get projectId(): string | undefined {
    return this.questionDoc?.data?.projectRef;
  }
  ...
  selectScripture(): void {
    if (this.textsByBookId == null) return;
  ...
  async submit(): Promise<void> {
    ...
    const response: CheckingResponse = {
      ...
      scripture: this.selectedText,
      scriptureStartClipped: this.selectionStartClipped,
      scriptureEndClipped: this.selectionEndClipped
    };

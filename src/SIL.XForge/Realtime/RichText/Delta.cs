...
public class Delta
{
    ...
    {
        private readonly List<int> opLengths = new List<int>();
        private readonly List<JObject> originalDeltaOps = new List<JObject>();
        private readonly List<JObject> newDeltaOps = new List<JObject>();
        private readonly bool retainCharIdsOnAttributes;

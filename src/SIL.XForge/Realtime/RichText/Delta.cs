...
{
    /// <summary>List of actions to apply to text, annotated with metadata and formatting.</summary>
    public class Delta
    {
        ...
        private class DeltaOpsAttributeHelper
        {
            ...
            /// <summary>Adds the ops to the given delta based on the ops added the instance of this class</summary>

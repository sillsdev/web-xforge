...
const confirmationData: ImportQuestionsConfirmationDialogData = {
  questions: [
    ...
    { before: 'Second question', after: 'Second question (edited)', answerCount: 1, checked: false },
    { before: 'Third question', after: 'A much better wording of the question', answerCount: 1, checked: true },
    { before: 'Question #4', after: 'Fourth question (edited)', answerCount: 1, checked: true }
  ]
};

...
namespace SIL.XForge.Scripture.Services
{
    ...
    public class ParatextService : DisposableBase, IParatextService
    {
        ...
        {
            using (ParatextAccessLock accessLock = await GetParatextAccessLock(userId, _registryClient))
            {
        ...
        {
            using (ParatextAccessLock accessLock = await GetParatextAccessLock(userSecret.Id, client))
        ...
        private async Task<ParatextAccessLock> GetParatextAccessLock(string userId, HttpClient client)
        {

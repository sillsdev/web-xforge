...
import { isPTRole } from './core/models/sf-project-role-info.js';
...
export class AppComponent extends DataLoadingComponent implements OnInit, OnDestroy {
  ...
  get showCheckingDisabled(): boolean {
    return (
      ...
      isPTRole(this.selectedProjectRole) === false
    );
  }
  ...
  get isTranslateEnabled(): boolean {
    return this.selectedProjectRole != null && isPTRole(this.selectedProjectRole);
  }

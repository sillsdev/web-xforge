...
import { ParatextNoteThread, PARATEXT_NOTE_THREAD_COLLECTION, PARATEXT_NOTE_THREAD_INDEX_PATHS } from "../models/paratext-note-thread";
...
export class ParatextNoteThreadService extends SFProjectDataService<ParatextNoteThread> {
  ...
  constructor() {
    ...
    const immutableProps = [
      ...
      this.pathTemplate(t => t.notes[ANY_INDEX].paratextUser),
  ...
  protected setupDomains(): ProjectDomainConfig[] {
    return [
      ...
      {
        projectDomain: SFProjectDomain.ParatextNote,

...
public class MachineProjectServiceTests
{
    ...
    {
        // Set up test environment
        var env = new TestEnvironment(new TestEnvironmentOptions { OneDraftingAndTrainingSource = true });
    ...
    public async Task SyncProjectCorporaAsync_Success(TestEnvironmentOptions options)
    {
        ...
        await env.Projects.UpdateAsync(
            ...
            op =>
            {
                ...
                if (options.OneDraftingAndTrainingSource)
                {
    ...
    public static IEnumerable<TestEnvironmentOptions> SyncProjectCorporaAsyncOptions
    {
        get
        {
            ...
            foreach (bool preTranslate in boolValues)
            {
                foreach (bool source in boolValues)
                {
                    foreach (bool oneDraftingAndTrainingSource in boolValues)
                    {
                        foreach (bool twoTrainingSources in boolValues)
                        {
                            ...
                            {
                                OneDraftingAndTrainingSource = oneDraftingAndTrainingSource || twoTrainingSources,
                                TwoTrainingSources = twoTrainingSources,
                ...
                {
                    OneDraftingAndTrainingSource = true,
    ...
    public record TestEnvironmentOptions
    {
        ...
        public bool OneDraftingAndTrainingSource { get; init; }
        public bool PreTranslate { get; init; }
        public bool Source { get; init; }
        public bool TwoTrainingSources { get; init; }
        ...
        private bool TrainingAndDraftingSourceAndNmt => OneDraftingAndTrainingSource && PreTranslate;
    ...
    private class TestEnvironment
    {
                ...
                [
                    ...
                    new SFProject
                    {
                        ...
                        TranslateConfig = new TranslateConfig
                        {
                            ...
                            DraftConfig = new DraftConfig
                            {
                                DraftingSources = options.OneDraftingAndTrainingSource
                                    ?
                                    [
                                        new TranslateSource
                                        {
                                    ...
                                    : [],
                                TrainingSources = options.OneDraftingAndTrainingSource
                                    ? options.TwoTrainingSources
                                        ?
                                        [
                                            new TranslateSource
                                            {
                            ...
                            PreTranslate = options.OneDraftingAndTrainingSource || options.TwoTrainingSources,
                        },
                        WritingSystem = new WritingSystem { Tag = "en_US" },
                    },
                    new SFProject
        ...
        )
        {
            ...
            if (options.OneDraftingAndTrainingSource && !options.DraftingSourceAndTrainingSourceAreTheSame)
            {
                await CorporaClient
                    .Received(createsServalCorpora ? 1 : 0)

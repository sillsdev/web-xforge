...
import { isDocCorrupted, VERSE_FROM_SEGMENT_REF_REGEX } from '../utils';
...
export class TextViewModel {
  ...
  get isDocCorrupted(): boolean {
    return this.textDoc?.isLoaded === true && this.textDoc.data?.ops != null && isDocCorrupted(this.textDoc.data.ops);
  }

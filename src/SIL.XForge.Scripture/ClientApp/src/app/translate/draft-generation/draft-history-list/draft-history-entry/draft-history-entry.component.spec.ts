...
describe('DraftHistoryEntryComponent', () => {
  ...
  beforeEach(() => {
    ...
    when(mockedDraftGenerationService.getBuildConfidences(anything(), anything())).thenReturn(of(undefined));
  ...
  describe('entry', () => {
    ...
    it('should show quality estimation when confidences are available', fakeAsync(() => {
      ...
      when(mockedDraftGenerationService.getBuildConfidences('project01', 'build01')).thenReturn(of(buildConfidences));
      const entry = getStandardBuildDto({});

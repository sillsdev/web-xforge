        ...
        if (listItem.alreadyImportedQuestion) {
          ...
          if (
            ...
            (doc.text !== listItem.question.text ||
              doc.verseRef.bookNum !== verseRefData.bookNum ||
              doc.verseRef.chapterNum !== verseRefData.chapterNum ||
              doc.verseRef.verseNum !== verseRefData.verseNum ||
  ...
  private verseRefData(q: TransceleratorQuestion): VerseRefData {
    ...
    return {
      ...
      verse:
        ...
        q.startChapter === q.endChapter && q.startVerse !== q.endVerse ? q.startVerse + '-' + q.endVerse : ''
    };
  }

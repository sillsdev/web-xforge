...
export async function editTranslation(
  ...
  // FIXME(application-bug) We should be able to use nth(1) here, but it seems there's an extra entry in the history
  ...
  await user.click(page.locator('#mat-button-toggle-10-button'));

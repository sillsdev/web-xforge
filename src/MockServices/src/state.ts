...
import type { AuthCodeRecord, ChaosRule, MockProject, MockResource, MockUser, RefreshTokenRecord } from './types.js';
...
export class MockState {
  ...
  load(): boolean {
    ...
    this.refreshTokens = new Map((snapshot.refreshTokens as RefreshTokenRecord[]).map(t => [t.token, t]));
    return true;
  }

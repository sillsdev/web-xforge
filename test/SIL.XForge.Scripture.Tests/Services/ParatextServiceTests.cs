    ...
    public class ParatextServiceTests
    {
        ...
        private class TestEnvironment
        {
            ...
            public TestEnvironment()
            {
                ...
                //Mock=Substitute.For<>();
                //Mock=Substitute.For<>();
                var ptservice = new ParatextService(MockHostingEnvironment, MockParatextOptions, MockRepository, MockRealtimeService, MockExceptionHandler, MockSiteOptions, MockFileSystemService);
            }
        }
    }
}

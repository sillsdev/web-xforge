...
namespace SIL.XForge.Scripture.Services
{
    ...
    public class ParatextSyncRunner
    {
        ...
        internal async Task<List<Chapter>> SyncOrCloneBookUsxAsync(TextInfo text, TextType textType, string paratextId,
        ...
        /// <summary>
        /// Fetches all real-time text docs for a book.
        /// </summary>
        internal async Task<SortedList<int, IDocument<Delta>>> FetchTextDocsAsync(TextInfo text, TextType textType)
        {
        ...
        /// <summary>
        /// Deletes the cached USX file and real-time text docs for a book.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the real-time text docs for a book.
        /// </summary>
        ...
        /// <summary>
        /// Deletes all real-time questions and comments docs for a book.
        /// </summary>

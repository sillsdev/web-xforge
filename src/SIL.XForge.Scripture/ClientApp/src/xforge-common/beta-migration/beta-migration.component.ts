...
import { USERS_COLLECTION, USER_PROFILES_COLLECTION } from 'realtime-server/lib/cjs/common/models/user';
import { QUESTIONS_COLLECTION } from 'realtime-server/lib/cjs/scriptureforge/models/question';
import { SF_PROJECTS_COLLECTION } from 'realtime-server/lib/cjs/scriptureforge/models/sf-project';
import { SF_PROJECT_USER_CONFIGS_COLLECTION } from 'realtime-server/lib/cjs/scriptureforge/models/sf-project-user-config';
import { TEXTS_COLLECTION } from 'realtime-server/lib/cjs/scriptureforge/models/text-data';

...
describe('TextChooserDialogComponent', () => {
  ...
  // it('provides the selection to caller when closed', fakeAsync(async () => {
  //   const selectionChangedPromise = TestEnvironment.setUpSelectionChange();
  //   const env = new TestEnvironment(
  //     TestEnvironment.defaultDialogData,
  //     [
  ...
  //     verses: { bookNum: 40, chapterNum: 1, verseNum: 1, verse: '1-3' },
  //     text: 'target: chapter 1, verse 1. target: chapter 1, verse',
  //     startClipped: false,
  //     endClipped: true
  //   });
  // }));

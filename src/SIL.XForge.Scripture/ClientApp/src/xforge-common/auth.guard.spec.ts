...
describe('AuthGuard', () => {
  ...
  it('should call login when not logged in', () => {
    // url test pattern: https://scriptureforge.org/projects/<projectId>
    const authGuard = new AuthGuard(instance(mockedAuthService), instance(mockedLocationService));
    expect(authGuard).toBeDefined();
  ...
  it('should call login when not logged in and sharing', () => {
  ...
  it('should call login when not logged in and signing up', () => {
  ...
  it('should call login when not logged in with locale', () => {

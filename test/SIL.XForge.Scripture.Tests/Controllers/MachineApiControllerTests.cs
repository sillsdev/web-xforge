...
public class MachineApiControllerTests
{
    ...
    [Test]
    public async Task HasPreTranslationsAsync_MachineApiDown()
    {
        // Set up test environment
        var env = new TestEnvironment();
        env.MachineApiService
        ...
        // SUT
        ActionResult<BuildDto?> actual = await env.Controller.HasPreTranslationsAsync(
            Project01,
            CancellationToken.None
        );
    ...
    [Test]
    public async Task HasPreTranslationsAsync_NoCompletedBuild()
    {
        // Set up test environment
        var env = new TestEnvironment();
        env.MachineApiService
    ...
    [Test]
    public async Task HasPreTranslationsAsync_NoPermission()
    {
        // Set up test environment
        var env = new TestEnvironment();
        env.MachineApiService
    ...
    [Test]
    public async Task HasPreTranslationsAsync_NoProject()
    {
        // Set up test environment
        var env = new TestEnvironment();
        env.MachineApiService
    ...
    [Test]
    public async Task HasPreTranslationsAsync_Success()
    {
        // Set up test environment
        var env = new TestEnvironment();
        env.MachineApiService

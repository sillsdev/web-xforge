...
describe('EditorComponent', () => {
  ...
  describe('Note threads', () => {
    ...
    it('handles insert at the last character position', fakeAsync(() => {
      ...
      env.addParatextNoteThread(7, 3, '.', { start: 27, length: 1 }, ['user01']);
      env.setProjectUserConfig();
      env.wait();
...
class TestEnvironment {
  ...
  constructor() {
    ...
    this.addParatextNoteThread(3, 3, 'verse 3', { start: 20, length: 7 }, ['user01']);
    this.addParatextNoteThread(4, 3, 'verse', { start: 20, length: 5 }, ['user01']);

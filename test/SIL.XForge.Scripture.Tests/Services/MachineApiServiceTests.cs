...
#pragma warning restore CS0612 // Type or member is obsolete
    ...
    public async Task GetPreTranslationDeltaAsync_SuccessSpecificConfig()
    {
        ...
        await env
            ...
            .GetPreTranslationUsfmAsync(
                ...
                40,
                1,
                Arg.Is<DraftUsfmConfig>(d => d.ParagraphBreakFormat == config.ParagraphBreakFormat),
                CancellationToken.None
            );
    }
    ...
    public async Task GetPreTranslationUsfmAsync_SuccessSpecificConfig()
    {
        ...
        var config = new DraftUsfmConfig { ParagraphBreakFormat = ParagraphBreakFormatOptions.Remove };
    ...
    public async Task GetPreTranslationUsjAsync_DoesNotSaveIfSpecificConfig()
    {
        // Set up test environment
        var env = new TestEnvironment();
        var config = new DraftUsfmConfig { ParagraphBreakFormat = ParagraphBreakFormatOptions.MoveToEnd };
        env.PreTranslationService.GetPreTranslationUsfmAsync(
                Project01,
                40,
                1,
                    ...
                    new SFProject
                    {
                        ...
                        TranslateConfig = new TranslateConfig
                        {
                            DraftConfig = new DraftConfig
                            {
                                ...
                                {
                                    ParagraphBreakFormat = ParagraphBreakFormatOptions.MoveToEnd,
                                },
                            },
                        },
